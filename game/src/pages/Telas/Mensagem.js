...
function Vida () {
  ...
  return (
    <div>
      ...
      <div className='titulo-mensagem absolute hidden'>Estamos próximos de celebrar os 30 anos da CIPD,</div>
      <div className='subtitulo-mensagem absolute hidden'>um marco para a saúde e os direitos reprodutivos.</div>

      <div className='mensagem absolute hidden'>A sua colaboração é muito importante para que os direitos das juventudes sejam considerados para esse futuro!</div>
