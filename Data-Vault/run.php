...
// Referencia
// https://celke.com.br/artigo/como-gerar-backup-do-banco-de-dados-com-php
...
try {
    $conn = new PDO("mysql:host=localhost;dbname=$dbname", "root", "", array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
...
if (($result_listar_tabelas) and ($result_listar_tabelas->rowCount() != 0)) {
    ...
    $nome_arquivo = "backup/db_backup_" . $username . "_" . $filename . ".sql";
    ...
    echo json_encode(["texto"=>$texto_arquivo, "mensagem"=>"Sucesso"]);
